...
@property (nonatomic, strong) CityModel *currentLocatedCityModel;
    ...
    [geocoder reverseGeocodeLocation:location completionHandler:^(NSArray *array, NSError *error){
        if(!self.hadUpdate) {
            if (array.count > 0){
                ...
                //得到当前定位到的城市
                self.currentLocatedCityModel = [CityModel cityModelWithCity:city longitude:coordinate.longitude latitude:coordinate.latitude];
